...
class ClothesShoes1 extends JPanel{
	JPanel a,b,c;
	JLabel title, deco, explain;
	private JRadioButton[] radio=new JRadioButton[2];
	private String[] text={"Brown","Black"};
	private ImageIcon[] image={new ImageIcon("images/b_shoes1.jpg"),new ImageIcon("images/b_shoes2.jpg")};
	private JLabel imagelabel=new JLabel();

	public ClothesShoes1(){
	...
	//상품정보
	explain=new JLabel("<html>상품명: 엘칸토 소가죽 구두<br/><br/>가격: 59500<br/><br/>구매처: Elcanto<br/><br/>링크 주소: http://www.elcanto.co.kr/</html>");
