...
//티, 긴바지, 구두
class Clothesgraphic2 extends JPanel implements ActionListener{
	JLabel option;
	...
	public void paintComponent(Graphics g) 
	{
		...
		//하의
		g.setColor(color1);
		g.fillRoundRect(350,140,60,100,15,10);
		g.fillRoundRect(420,140,60,100,15,10);
		...
		g.fillRect(384,238,25,25);
		g.fillOval(420,230,90,25);
		g.fillRect(422,238,25,25);	
