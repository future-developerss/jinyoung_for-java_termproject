...
public class ClothesResultB158 extends JFrame{
	...
	public String name;
    public ClothesResultB158(String msg) {
		name=msg;
		...
		//결과창
		one=new JPanel();  
		one.add(new ClothesTop1());
		two=new JPanel(); 
		two.add(new ClothesPants1());
		three=new JPanel(); 
		three.add(new ClothesShoes2());
		four=new JPanel();
		four=new Clothesgraphic3();
		tp=new JTabbedPane();  
...
private class MyActionListener implements ActionListener{
		public void actionPerformed(ActionEvent e){
			...
			{
				//이전페이지로 이동
				new ClothesB_3Q2(ClothesResultB158.this.name);
				ClothesResultB158.this.setVisible(false);
			...
			{
				//설문조사창 연결하기
				new survey(ClothesResultB158.this.name);
				ClothesResultB158.this.setVisible(false);
			}
	}
}
