...
public class ClothesResultB258 extends JFrame{
	...
	public String name;
    public ClothesResultB258(String msg) {
		name=msg;
...
private class MyActionListener implements ActionListener{
		public void actionPerformed(ActionEvent e){
			...
			{
				//이전페이지로 이동
				new ClothesB_2Q2(ClothesResultB258.this.name);
			...
			{
				//설문조사창 연결
				new survey(ClothesResultB258.this.name);
				ClothesResultB258.this.setVisible(false);
			}
	}
}
