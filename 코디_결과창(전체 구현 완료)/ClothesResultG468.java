...
public class ClothesResultG468 extends JFrame{
...
public String name;
    public ClothesResultG468(String msg) {
		name=msg;
...
private class MyActionListener implements ActionListener{
		public void actionPerformed(ActionEvent e){
			...
			{
				//이전페이지로 이동
				new ClothesG_1Q2(ClothesResultG468.this.name);
				ClothesResultG468.this.setVisible(false);
			...
			{
				//설문조사창 연결하기
				new survey(ClothesResultG468.this.name);
				ClothesResultG468.this.setVisible(false);
			}
	}
}
