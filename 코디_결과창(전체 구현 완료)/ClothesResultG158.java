...
public class ClothesResultG158 extends JFrame{
...
public String name;
    public ClothesResultG158(String msg) {
		name=msg;
...
private class MyActionListener implements ActionListener{
		public void actionPerformed(ActionEvent e){
			...
			{
				//이전페이지로 이동
				new ClothesG_3Q2(ClothesResultG158.this.name);
				ClothesResultG158.this.setVisible(false);
			...
			{
				//설문조사창 연결하기
				new survey(ClothesResultG158.this.name);
				ClothesResultG158.this.setVisible(false);
			}
	}
}
