...
public class ClothesResultG367 extends JFrame{
...
public String name;
    public ClothesResultG367(String msg) {
		name=msg;
		...
		//결과창
		one=new JPanel();  
		one.add(new ClothesTopc());
		two=new JPanel(); 
		two.add(new ClothesPantsb());
		three=new JPanel(); 
...
private class MyActionListener implements ActionListener{
		public void actionPerformed(ActionEvent e){
			...
			{
				//이전페이지로 이동
				new ClothesG_1Q2(ClothesResultG367.this.name);
				ClothesResultG367.this.setVisible(false);
			...
			{
				new survey(ClothesResultG367.this.name);
				ClothesResultG367.this.setVisible(false);
			}
	}
}
