...
public class ClothesResultB367 extends JFrame{
	...
	public String name;
    public ClothesResultB367(String msg) {
		name=msg;
		...
		//결과창
		one=new JPanel();  
		one.add(new ClothesTop3());
		two=new JPanel(); 
		two.add(new ClothesPants2());
		three=new JPanel(); 
		three.add(new ClothesShoes1());
		four=new JPanel();
		four=new Clothesgraphic();
		tp=new JTabbedPane();  
...
private class MyActionListener implements ActionListener{
		public void actionPerformed(ActionEvent e){
			...
			{
				//이전페이지로 이동
				new ClothesB_1Q2(ClothesResultB367.this.name);
				ClothesResultB367.this.setVisible(false);
			...
			{
				//설문조사창 연결하기
				new survey(ClothesResultB367.this.name);
				ClothesResultB367.this.setVisible(false);
			}
	}
}
