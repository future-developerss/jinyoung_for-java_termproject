...
public class ClothesResultG258 extends JFrame{
...
public String name;
    public ClothesResultG258(String msg) {
		name=msg;
...
private class MyActionListener implements ActionListener{
		public void actionPerformed(ActionEvent e){
			...
			{
				//이전페이지로 이동
				new ClothesG_2Q2(ClothesResultG258.this.name);
				ClothesResultG258.this.setVisible(false);
			...
			{
				//설문조사창 연결하기
				new survey(ClothesResultG258.this.name);
				ClothesResultG258.this.setVisible(false);
			}
	}
}
