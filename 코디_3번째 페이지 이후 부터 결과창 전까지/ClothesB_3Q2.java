...
public class ClothesB_3Q2 extends JFrame{
	...
	public String name;
    public ClothesB_3Q2(String msg) {
		name=msg;
        setTitle(name+"의 선택은?");
...
private class MyActionListener implements ActionListener{
		public void actionPerformed(ActionEvent e){
			...
			{
				//이전페이지로 이동
				new fourthPageB_Q1(ClothesB_3Q2.this.name);
				ClothesB_3Q2.this.setVisible(false);
...
private class AnswerListener implements ActionListener{
		public void actionPerformed(ActionEvent e){
			...
			if (b.getText().equals("면접/회사 출근")){
				new ClothesResultB158(ClothesB_3Q2.this.name);
				ClothesB_3Q2.this.setVisible(false);
			}else if (b.getText().equals("친구 약속/여행"))
			{
				...
				//근처 마실
				new ClothesResultB258(ClothesB_3Q2.this.name);
				ClothesB_3Q2.this.setVisible(false);
			}
		}
	}
